...
extension ProtectedLivePreviewPlayerController on LivePreviewPlayerController {
...
class LivePreviewPlayerController {
        ...
        return AnimatedBuilder(
          ...
          builder: (BuildContext context, Widget? child) {
            return FullscreenVideoPlayer(
              livePreviewPlayerController: this,
            );
          },
        );
      },
  ...
  Future<void> _exitFullscreen() async {
    ...
    await SystemChrome.setPreferredOrientations(
        DeviceOrientation.values); // reset device orientation values
    _isFullscreen = false;
...
class FullscreenVideoPlayer extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return WillPopScope(
      onWillPop: () async {
        livePreviewPlayerController.setFullscreen(false);
        return false;
      },
      child: Scaffold(
